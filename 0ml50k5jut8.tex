...
and therefore:
\begin{equation}
h^g()-h^f() \approx 2.26 - 2.19 T_c \, {\rm if}\ T_c^\circ > 0
\end{equation}
...
\begin{equation}
(c_p^e \theta^e + 4.186 \theta^f + 1.996 \theta^g) \frac{dT_c}{dt} = 2.26 - 2.19 T_c \frac{d\theta^f}{dt}\, {\rm if}\ C^\circ > 0
\end{equation}
...
\begin{equation}
\frac{d\theta^f}{dt} < - 1.032\,  ^\circ T_^{-1} 
\end{equation}